...
function SignUp({handleSignupToggle,}) {
    return (
        <div className={signUpStyle.container}>
            <h1 style={{color:'#ffff'}}>SignUp Form</h1>
            <form id="SignUp" className={signUpStyle.form} onSubmit={(e)=>{handleSignupSubmit();}}>
                ...
                <div className={signUpStyle.inputBox}>
                    ...
                    <input className={signUpStyle.inputStyle} type="password" placeholder='Create Password'/>
                </div>
                <div className={signUpStyle.inputBox}>
                    <FaLock className={signUpStyle.icon}/>
                    <input className={signUpStyle.inputStyle} type="password" placeholder='Confirm password'/>
                </div>
                <div className={signUpStyle.footer}>
                    <button className={signUpStyle.button} type='submit'>SignUp</button>
                    <p>Already have an account? <span style={{cursor:'pointer'}} onClick={(e) => { e.preventDefault(); handleSignupToggle(); }}>SignIn</span></p>
                </div>
            </form>
        </div>
    )
